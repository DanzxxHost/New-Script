...
client.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'close') {
          ...
          let teksnotif = `Berhasil Tersambung Ke Nomor WhatsApp ${client.user.id.split(":")[0]}`
  client.sendMessage("6283149813374@s.whatsapp.net", {text: teksnotif})
